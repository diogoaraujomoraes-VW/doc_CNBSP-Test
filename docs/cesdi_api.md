...
### `anexosEspecificos <LISTA>`

| Obrigatório | Tipo | Tamanho | Formato | Descrição |
|:-----------:|:----:|:-------:|:-------:|-----------|
| NÃO | LISTA / BLOCO | - | - | Lista de informações de anexos específicos do ato. Verificar abaixo os itens de campos da lista |
...
## Dados Estado Civil - Preenchido somente quando o campo "estadoCivilParte" for "CASADO"
...
## Dados Bens e Direitos - (Nenhum campo abaixo deverá ser preenchido se o campo "bensEdireitos" for FALSO)
...
## Esta é uma sublista contida dentro das informações da lista "bensEdireitos"
...
## ITENS DA LISTA - ANEXOSESPECIFICOS
